...
Generating figures for v8 of MC manuscript.
...
data_file <- paste(analysis_dir, "MC_IHC_Counts.xlsx", sep="/")

h_counts <- read_excel(path = data_file, sheet = "Healthy")
...
print(generate_patient_proportion_plot(seur_har$imm, ident_var = "ident_PLOT_format", group_var = "Cohort", group_selection = c("Active_MC", "Chron_Diarr", "Healthy")) + ylab("Enrichment") + xlab("") + theme(legend.position="bottom", axis.text.x = element_markdown(margin=margin(b=-0.75, unit='cm'))) + labs(fill=""))
dev.off()
```
...
CD8 Boxplot
```{r}
p1 <- make_boxplot(seur_har$imm, ident_var = "ident_PLOT", c("T CD8+"), selected_name = "CD8 T Cells", selected_groups = c("Active_MC", "Chron_Diarr", "Healthy")) +
  guides(fill=F) +
  theme(axis.text.x = element_blank()) +
  theme(plot.title = element_markdown())
p2 <- make_boxplot(seur_har$imm, ident_var = "ident_PLOT", c("T CD4+"), selected_name = "CD4 T Cells", selected_groups = c("Active_MC", "Chron_Diarr", "Healthy")) +
  guides(fill=F) +
  theme(axis.text.x = element_blank(), axis.title.y = element_blank()) +
  theme(plot.title = element_markdown())
p3 <- make_boxplot(seur_har$imm, ident_var = "ident_PLOT", c("B Activated", "B GC", "B Naive"), selected_name = "B Cells", selected_groups = c("Active_MC", "Chron_Diarr", "Healthy")) +
  guides(fill=F) +
  theme(axis.text.x = element_blank()) +
  theme(plot.title = element_markdown())
p4 <- make_boxplot(seur_har$imm, ident_var = "ident_PLOT", c("Macrophage", "Monocyte", "Mast", "Neutrophil", "DC"), selected_name = "Myeloid Cells", selected_groups = c("Active_MC", "Chron_Diarr", "Healthy")) +
  guides(fill=F) +
  theme(axis.text.x = element_blank(), axis.title.y = element_blank()) +
  theme(plot.title = element_markdown())
...
make_boxplot_idents_separate(cycling_subset,
                             ident_var = "ident_L2_plot",
                             selected_name = "Cycling Cells",
                             selected_groups = c("Active_MC", "Chron_Diarr", "Healthy")) +
...
print(generate_patient_proportion_plot(cd8_subset, ident_var = "ident_L3_plot", group_var = "Cohort", group_selection = c("Active_MC", "Chron_Diarr", "Healthy")) + ylab("Enrichment") + xlab("") + theme(legend.position="bottom", axis.text.x = element_markdown(margin=margin(b=-0.75, unit='cm')))+ guides(fill=F)) 
dev.off()
```
...
make_boxplot_idents_separate(cd8_subset, ident_var = "ident_L3_plot", selected_name = "CD8 T Cells", selected_groups = c("Active_MC", "Chron_Diarr", "Healthy")) +
  theme(axis.title.x=element_blank(),
...
pdf(file=paste(fig_dir, "SuppFig4_BarPlot_Clonotypes.pdf", sep="/"), width = 6, height=4)
...
pdf(file=paste(fig_dir, "SuppFig4_Boxplot_TCR-Diversity.pdf", sep="/"), width = 3, height=3)
...
he <- subset(imm_sub_2$`T CD8+`, Cohort=="Healthy")
...
shared_ctype_clust_he <- as.data.frame(t(apply(shared_ctype_clust, MARGIN = 1, get_num_shared_ctype, meta=subset(comb_meta, Cohort=="Healthy"))))
shared_ctype_clust_he$Cohort <- "Healthy"
...
pdf(file=paste(fig_dir, "SuppFig4_CD8_Clonotype_UMAP-and-table.pdf", sep="/"), width = 10, height=7)
...
run_fisher <- function(.df, .y){
  ...
  .cont_he <- .cont %>% filter(Cohort %in% c("Active_MC", "Healthy"))
  .cd_p <- fisher.test(.cont_cd[,2:3])$p.value
  .he_p <- fisher.test(.cont_he[,2:3])$p.value
  return(data.frame("comp"=c("CD", "Healthy"), "p_val"=c(.cd_p, .he_p)))
}
...
pdf(file=paste(fig_dir, "Fig4_umap_cd4.pdf", sep="/"), width = 5, height=5)
...
pdf(file=paste(fig_dir, "Fig4_DotPlot.pdf", sep="/"), width = 4, height=4)
...
pdf(file=paste(fig_dir, "Fig4_PropPlot.pdf", sep="/"), width = 3.5, height=3)
print(generate_patient_proportion_plot(cd4_subset, ident_var = "ident_L3_plot", group_var = "Cohort", group_selection = c("Active_MC", "Chron_Diarr", "Healthy")) +
        ylab("Enrichment") +
        xlab("") +
        labs(fill="") +
...
pdf(file=paste(fig_dir, "Fig4_Boxplot_CD4_Subsets.pdf", sep="/"), width = 5, height=3)
make_boxplot_idents_separate(cd4_subset, ident_var = "ident_L3_plot", selected_name = "CD4 T cells", selected_groups = c("Active_MC", "Chron_Diarr", "Healthy")) +
  theme(axis.title.x=element_blank(),
        legend.position = "bottom",
        axis.text.x = element_markdown(margin=margin(b=-0.4, unit='cm')),
...
run_de_per_cluster <- function(counts, meta, group_var="Cohort"){
  ...
  for(c in clusts){
    ...
    if("Healthy" %in% coh_present){
      h_qlt <- glmQLFTest(fit, contrast=makeContrasts(CohortActive_MC - CohortHealthy, levels=design))
      topgenes_h <- topTags(h_qlt, n=nrow(c_counts))
      topgenes[["H"]] <- topgenes_h$table
    }
    else{print("Healthy data not present, skipping this comparison...")}
...
```{r}
jpeg(file=paste(fig_dir, "SuppFig23_TechComp_Imm.jpg", sep="/"), width = 8, height=4, units="in", res=300)
print(tech_comp_plot(seur_har$imm, title="Immune Cells"))
dev.off()

jpeg(file=paste(fig_dir, "SuppFig23_TechComp_TCD8.jpg", sep="/"), width = 8, height=4, units="in", res=300)
print(tech_comp_plot(imm_sub_2$`T CD8+`, title="CD8 T Cells"))
dev.off()

jpeg(file=paste(fig_dir, "SuppFig23_TechComp_TCD4.jpg", sep="/"), width = 8, height=4, units="in", res=300)
print(tech_comp_plot(imm_sub_2$`T CD4+`, title="CD4 T Cells"))
dev.off()

jpeg(file=paste(fig_dir, "SuppFig23_TechComp_Mye.jpg", sep="/"), width = 8, height=4, units="in", res=300)
print(tech_comp_plot(imm_sub$Mac_Mon_DC, title="Myeloid Cells"))
dev.off()

jpeg(file=paste(fig_dir, "SuppFig23_TechComp_Plas.jpg", sep="/"), width = 8, height=4, units="in", res=300)
...
pdf(file=paste(fig_dir, "SuppFig1_clust_pat_counts.pdf", sep="/"), width = 8, height=6)
...
pdf(file=paste(fig_dir, "SuppFig1_clust_pat_props.pdf", sep="/"), width = 8, height=6)
...
pdf(file=paste(fig_dir, "SuppFig4_umap.pdf", sep="/"), width = 4.5, height=4.5)
...
pdf(file=paste(fig_dir, "SuppFig4_stacked_violin.pdf", sep="/"), width = 3.25, height=4.5)
...
Proportion plots
```{r}
pdf(file=paste(fig_dir, "SuppFig4_PropPlot.pdf", sep="/"), width = 3, height=2.5)
print(generate_patient_proportion_plot(myeloid_subset,
                                       ident_var = "ident_L2_format",
                                       group_var = "Cohort",
                                       group_selection = c("Active_MC", "Chron_Diarr", "Healthy")) +
        ylab("Enrichment") +
        xlab("") +
...
pdf(file=paste(fig_dir, "SuppFig4_BoxPlot_Myeloid.pdf", sep="/"), width = 5, height=3)
make_boxplot_idents_separate(myeloid_subset,
                             ident_var = "ident_L2_format",
...
pdf(file=paste(fig_dir, "SuppFig2_stacked_violin_epi.pdf", sep="/"), width = 3.25, height=5)
...
pdf(file=paste(fig_dir, "SuppFig2_UMAP_str.pdf", sep="/"), width = 4.5, height=4.5)
...
pdf(file=paste(fig_dir, "SuppFig2_stacked_violin_str.pdf", sep="/"), width = 3.25, height=5)
...
pdf(file=paste(fig_dir, "SuppFig11_umap_b.pdf", sep="/"), width = 4.5, height=4.5)
...
pdf(file=paste(fig_dir, "SuppFig11_stacked_violin.pdf", sep="/"), width = 3, height=4)
...
Proportion plots
```{r}
pdf(file=paste(fig_dir, "SuppFig11_PropPlot.pdf", sep="/"), width = 3.5, height=3)
print(generate_patient_proportion_plot(b_subset,
        ...
        scale_fill_discrete(labels=c("Active_MC" = "Active MC", "Chron_Diarr"="Chronic Diarrhea", "Healthy"="Healthy")))
dev.off()
...
Boxplots
```{r}
pdf(file=paste(fig_dir, "SuppFig11_BoxPlot_B.pdf", sep="/"), width = 2.5, height=2)
make_boxplot(seur_har$imm,
...
pdf(file=paste(fig_dir, "SuppFig11_BoxPlot_Plasma.pdf", sep="/"), width = 2.5, height=2)
make_boxplot(seur_har$imm,
             ident_var = "ident_PLOT",
             c("Plasma"),
...
pdf(file=paste(fig_dir, "SuppFig11_Boxplot_B_subsets.pdf", sep="/"), width = 4, height=2.5)
make_boxplot_idents_separate(b_subset,
                             ident_var = "ident_L2",
                             selected_name = "B Cells",
                             selected_groups = c("Active_MC", "Chron_Diarr", "Healthy")) +
  theme(axis.title.x=element_blank(),
...
pdf(file=paste(fig_dir, "SuppFig11_Boxplot_Plasma_sub.pdf", sep="/"), width = 3.5, height=2.5)
make_boxplot_idents_separate(imm_sub$Plasma,
                             ident_var = "ident_L2",
                             selected_name = "Plasma Cells",
                             selected_groups = c("Active_MC", "Chron_Diarr", "Healthy")) +
  theme(axis.title.x=element_blank(),
...
```{r}
tmp <- subset(imm_sub$`Plasma`, Cohort %in% c("Active_MC", "Chron_Diarr", "Healthy"))

pdf(file=paste(fig_dir, "SuppFig11_DotPlot_Plasma.pdf", sep="/"), width = 4, height=3)
DotPlot(tmp,"RNA", c("ITGA4", "ITGB7", "ITGAE"), group.by="Cohort") +
  ...
  scale_y_discrete(breaks = c("Active_MC", "Chron_Diarr", "Healthy"), labels=c("Active MC", "Chronic\nDiarrhea", "Healthy"))
dev.off()
...
plas_counts <- plas_counts[plas_counts$Cohort %in% c("Active_MC", "Healthy", "Chron_Diarr"),]
...
pdf(file=paste(fig_dir, "SuppFig11_BoxPlot_PlasmaProps.pdf", sep="/"), width = 3, height=3)
...
Proportion plots
```{r}
pdf(file=paste(fig_dir, "SuppFig3_PropPlot_indrops_v_10x.pdf", sep="/"), width = 4, height=2)
...
pdf(file=paste(fig_dir, "SuppFig3_PropPlot_10X.pdf", sep="/"), width = 4, height=3)
print(generate_patient_proportion_plot(tenX, ident_var = "ident_PLOT_format", group_var = "Cohort", group_selection = c("Active_MC", "Chron_Diarr", "Healthy")) +
        ggtitle("10X") +
        ylab("Enrichment") +
        xlab("") +
...
pdf(file=paste(fig_dir, "SuppFig3_PropPlot_indrops.pdf", sep="/"), width = 4, height=3)
print(generate_patient_proportion_plot(inDrops, ident_var = "ident_PLOT_format", group_var = "Cohort", group_selection = c("Active_MC", "Chron_Diarr", "Healthy"))+
        ggtitle("inDrops") +
        ylab("Enrichment") +
        xlab("") +
        theme(legend.position="bottom", axis.text.x = element_markdown(margin=margin(b=-0.8, unit='cm'))) +
...
Box plots
```{r}
pdf(file=paste(fig_dir, "SuppFig3_BoxPlot_CD8_10X.pdf", sep="/"), width = 2, height=2)
make_boxplot(tenX, ident_var = "ident_PLOT", c("T CD8+"), selected_name = "10X CD8 T", selected_groups = c("Active_MC", "Chron_Diarr", "Healthy")) +
  guides(fill=F)+
  theme(plot.title = element_markdown()) 
dev.off()

pdf(file=paste(fig_dir, "SuppFig3_BoxPlot_CD8_inDrops.pdf", sep="/"), width = 2, height=2)
make_boxplot(inDrops, ident_var = "ident_PLOT", c("T CD8+"), selected_name = "inDrops CD8 T", selected_groups = c("Active_MC", "Chron_Diarr", "Healthy")) +
  guides(fill=F)+
  theme(plot.title = element_markdown())
dev.off()
```
...
pdf(file=paste(fig_dir, "SuppFig3_BoxPlot_CD8_subsets_inDrops.pdf", sep="/"), width = 3.5, height=2)
make_boxplot_idents_separate(cd8_indrops, ident_var = "ident_L3_format", selected_name = "inDrops CD8 T cells", selected_groups = c("Active_MC", "Chron_Diarr", "Healthy")) +
  ylab("Proportion") +
  xlab("") +
  theme(legend.position="bottom",
        legend.title = element_blank(),
...
pdf(file=paste(fig_dir, "SuppFig3_BoxPlot_CD8_subsets_10X.pdf", sep="/"), width = 3.5, height=2)
make_boxplot_idents_separate(cd8_10X, ident_var = "ident_L3_format", selected_name = "10X CD8 T cells", selected_groups = c("Active_MC", "Chron_Diarr", "Healthy")) +
  ylab("Proportion") +
  xlab("") +
  theme(legend.position="bottom",
        legend.title = element_blank(),
...
pdf(file=paste(fig_dir, "SuppFig3_BoxPlot_CD4_subsets_inDrops.pdf", sep="/"), width = 3.5, height=2)
make_boxplot_idents_separate(cd4_indrops, ident_var = "ident_L3_format", selected_name = "inDrops CD4 T cells", selected_groups = c("Active_MC", "Chron_Diarr", "Healthy")) +
  ylab("Proportion") +
  xlab("") +
  theme(legend.position="bottom",
        legend.title = element_blank(),
...
pdf(file=paste(fig_dir, "SuppFig3_BoxPlot_CD4_subsets_10X.pdf", sep="/"), width = 3.5, height=2)
make_boxplot_idents_separate(cd4_10X, ident_var = "ident_L3_format", selected_name = "10X CD4 T cells", selected_groups = c("Active_MC", "Chron_Diarr", "Healthy")) +
  ylab("Proportion") +
  xlab("") +
  theme(legend.position="bottom",
        legend.title = element_blank(),
...
cohort_select <- subset(cd8_subset, Cohort %in% c("Active_MC", "Chron_Diarr", "Healthy"))
...
jpeg(file=paste(fig_dir, "SuppFig24_IFNG_FeaturePlot.jpg", sep="/"), width = 7, height=10, units="in", res=300)
...
```{r}
pdf(file=paste(fig_dir, "CD8_Boxplot.pdf", sep="/"), width = 7, height = 3)
ggplot(subset(cellcounts, Stain=="CD8"), aes(x=Cohort, y=count)) +
  ...
  ggtitle("CD8+ Cells") +
  scale_x_discrete(labels=c("Active_MC" = "Active MC", "Chron_Diarr"="Chronic Diarrhea", "Healthy"="Healthy"))
dev.off()
```
...
run_pois <- function(.df, .y){
  ...
  he_pv <- pois_sum$coefficients["CohortHealthy",4]
  to_ret <- data.frame(control=c("CD", "Healthy"), pval=c(cd_pv, he_pv))
  return(to_ret)
}
...
```{r}
pdf(file=paste(fig_dir, "GZMB_Boxplot.pdf", sep="/"), width = 7, height = 3)
...
pdf(file=paste(fig_dir, "SuppFig20_DotPlot_Circ_T.pdf", sep="/"), width = 8, height=5)
...
```{r}
pdf(file=paste(fig_dir, "CD4_Boxplot.pdf", sep="/"), width = 7, height = 3)
...
pdf(file=paste(fig_dir, "FOXP3_Boxplot.pdf", sep="/"), width = 7, height = 3)
...
pdf(file=paste(fig_dir, "SuppFig5_DEGs_grouped.pdf", sep="/"), width = 13, height=15)
tmp_plot + theme(legend.position="bottom", axis.title.x=element_blank()) + guides(fill=guide_legend(nrow=1,byrow=TRUE))
dev.off()

jpeg(file=paste(fig_dir, "SuppFig5_DEGs_grouped.jpg", sep="/"), width = 13, height=15, units="in", res=300)
tmp_plot + theme(legend.position="bottom", axis.title.x=element_blank()) + guides(fill=guide_legend(nrow=1,byrow=TRUE))
dev.off()
```
...
pdf(file=paste(fig_dir, "SuppFig5_umap_Macrophage.pdf", sep="/"), width = 4.5, height=4.5)
tmp <- format_plot_umap_with_num(mac_subset, "ident_L3", gene_mod, lp="bottom", nc=2)
dev.off()


jpeg(file=paste(fig_dir, "SuppFig5_umap_Macrophage.jpg", sep="/"), width = 4.5, height=4.5, units="in", res=300)
tmp <- format_plot_umap_with_num(mac_subset, "ident_L3", gene_mod, lp="bottom", nc=2)
dev.off()
```
...
pdf(file=paste(fig_dir, "SuppFig5_stacked_violin_Mac.pdf", sep="/"), width = 3, height=3.5)
StackedVlnPlot(mac_subset, features.plot, y_3_pt = T)
dev.off()

jpeg(file=paste(fig_dir, "SuppFig5_stacked_violin_Mac.jpg", sep="/"), width = 3, height=3.5, units="in", res=300)
StackedVlnPlot(mac_subset, features.plot, y_3_pt = T)
dev.off()
...
Proportion plots
```{r}
pdf(file=paste(fig_dir, "SuppFig5_PropPlot_Macrophage.pdf", sep="/"), width = 3, height=2.7)
...
jpeg(file=paste(fig_dir, "SuppFig5_PropPlot_Macrophage.jpg", sep="/"), width = 2, height=2.7, units="in", res=300)
print(generate_patient_proportion_plot(mac_subset,
                                       ident_var = "ident_L3_format",
                                       group_var = "Cohort",
                                       group_selection = c("Active_MC", "Chron_Diarr", "Healthy")) +
...
jpeg(file=paste(fig_dir, "SuppFig5_BoxPlot_Macrophage.jpg", sep="/"), width = 4, height=3.5, units="in", res=300)
...
```{r}
#Proportion plots
pdf(file=paste(fig_dir, "SuppFig6_PropPlot_coll-vs-lymph.pdf", sep="/"), width = 4, height=3)
...
pdf(file=paste(fig_dir, "SuppFig6_BoxPlot_CD8_subsets_coll-vs-lymph.pdf", sep="/"), width = 6, height=4)
make_boxplot_idents_separate(cd8_subset,
                             ident_var = "ident_L3_plot",
                             selected_name = "CD8 T cells",
                             group_var = "Cohort_Sub",
                             selected_groups = c("MC_Collagenous", "MC_Lymphocytic", "Chron_Diarr", "Healthy")) +
  ylab("Proportion") +
  xlab("") +
  theme(legend.position="bottom",
        legend.title = element_blank(),
...
pdf(file=paste(fig_dir, "SuppFig6_BoxPlot_CD4_subsets_lymph.pdf", sep="/"), width = 6, height=4)
make_boxplot_idents_separate(cd4_subset,
                             ident_var = "ident_L3_plot",
